    ...
    <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex gap-2">
                <div class="">
                    <a href="{{ route('hasil-proposal.export', ['prodi' => $prodi, 'id' => auth()->user()->dosen->id]) }}" id="exportButton" class="btn btn-outline-secondary">Export</a>
                </div>
                <div class="">
            ...
            <div class="table-container" style="overflow-x: auto;">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            @if($d->hasilProposal->where('id_dosen', auth()->user()->dosen->id)->isEmpty())
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('hasil-proposal.create', ['dosen' => auth()->user()->dosen->id, 'id' => $d->id, 'prodi' => $prodi]) }}">Input Nilai
                            </a>
                            @else
