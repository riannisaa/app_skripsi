    ...
    <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex gap-2">
                <div class="">
                    <a href="{{ route('hasil-skripsi.export', ['prodi' => $prodi, 'id' => auth()->user()->dosen->id]) }}" id="exportButton" class="btn btn-outline-secondary">Export</a>
                </div>
                <div class="">
            ...
            <div class="table-container" style="overflow-x: auto;">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th style="white-space: nowrap;">Input Nilai</th>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($d->jadwalSidang->penguji1->id == auth()->user()->dosen->id && !$d->status_revisi)
                        ...
                        <td style="white-space: nowrap;">
                            @if($d->file_pengesahan)
                            @if($d->jadwalSidang->penguji1->id == auth()->user()->dosen->id)
                            @if($d->acc_penguji_1)
                            ...
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('jadwal-skripsi.acc-dosen', ['acc_penguji_1' => true, 'id'=>$d->id]) }}">ACC
                            </a>
                            @endif
                            @elseif($d->jadwalSidang->penguji2->id == auth()->user()->dosen->id)
                            @if($d->acc_penguji_2)
                            <button disabled class="btn btn-sm btn-primary">
                                Sudah ACC
                            </button>
                            @else
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('jadwal-skripsi.acc-dosen', ['acc_penguji_2' => true, 'id'=>$d->id ]) }}">ACC
                            </a>
                            @endif
                            @elseif($d->berkasSkripsi->pengajuanDospem->dospem1->id == auth()->user()->dosen->id)
                            ...
                            @else
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('jadwal-skripsi.acc-dosen', ['acc_pembimbing_1' => true, 'id'=>$d->id]) }}">ACC
                            </a>
                            @endif
                            @elseif($d->berkasSkripsi->pengajuanDospem->dospem2->id == auth()->user()->dosen->id)
                            ...
                            @else
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('jadwal-skripsi.acc-dosen', ['acc_pembimbing_2' => true, 'id'=>$d->id]) }}">ACC
                            </a>
                            @endif
                            @endif
                            @else
                        ...
                        <td style="white-space: nowrap;">
                            @if($d->jadwalSidang->id_pembimbing == auth()->user()->dosen->id || $d->jadwalSidang->id_penguji_1 == auth()->user()->dosen->id || $d->jadwalSidang->id_penguji_2 == auth()->user()->dosen->id)
                            @if($d->hasilSkripsiPembimbing->where('id_dosen', auth()->user()->dosen->id)->isEmpty() && $d->hasilSkripsiPenguji->where('id_dosen', auth()->user()->dosen->id)->isEmpty())
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('hasil-skripsi.create', ['id' => $d->id, 'prodi'=>$prodi]) }}">Input Nilai
                            </a>
                            @else
                            <button class="btn btn-sm btn-primary" disabled>Input Nilai</button>
                            @endif
                            @else
                            <button class="btn btn-sm btn-primary" disabled>Input Nilai</button>
                            @endif
