...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const submitButton = document.getElementById('submit-button'); // Ensure your submit button has this ID

        function fetchAvailableWaktu() {
        ...
        [prodi, jenisSidang, tanggal].forEach(input => {
            input.addEventListener('change', fetchAvailableWaktu);
        });
    });
</script>
