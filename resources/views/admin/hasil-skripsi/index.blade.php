...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Approval Bebas Pustaka</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('jadwal-skripsi.update-pustaka') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 col-md-10 mx-auto">
                        ...
                        <select class="form-select" id="status" name="bebas_pustaka">
