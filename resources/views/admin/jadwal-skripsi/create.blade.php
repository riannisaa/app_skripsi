...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <h2 class="mt-4 mb-4 text-center">Form Buat Jadwal <br> Sidang Skripsi</h2>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('jadwal-skripsi.store') }}">
                    @csrf
                    ...
                    <div class="mb-3 col-md-8 mx-auto">
                        <label class="small mb-1" for="nama_dosen">Penguji I Proposal</label>
                        <input class="form-control" disabled id="pengujiProposal1">
                    </div><div class="mb-3 col-md-8 mx-auto">
                        <label class="small mb-1" for="nama_dosen">Penguji II Proposal</label>
                        <input class="form-control" disabled id="pengujiProposal2">
                    </div>
                    @endif
                    <div class="mb-3 col-md-8 mx-auto">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const pengujiProposal1 = document.getElementById('pengujiProposal1');
        const pengujiProposal2 = document.getElementById('pengujiProposal2');
        ...
        mahasiswaSelect.addEventListener('change', function() {
            ...
            fetch(`/mahasiswa-info?id=${selectedId}`)
                ...
                .then(data => {
                    ...
                    prodi = data.prodi;
                    if(pengujiProposal1 && pengujiProposal2){
                        pengujiProposal1.value = data.penguji1;
                        pengujiProposal2.value = data.penguji2;
                    }
        ...
        tanggalInput.addEventListener('change', function() {
            ...
            fetch(`/get-plot-jadwal?date=${tanggal}&prodi=${prodi}&jenis=Skripsi`)
                .then(response => response.json())
                .then(data => {
