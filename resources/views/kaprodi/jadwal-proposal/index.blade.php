    ...
    <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex gap-2">
                <div class="">
                    <a href="{{ route('jadwal-proposal.export', ['prodi' => $prodi]) }}" id="exportButton" class="btn btn-outline-secondary">Export</a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Approval Jadwal Sidang Proposal</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('jadwal-proposal.update-status') }}" method="POST">
                @csrf
