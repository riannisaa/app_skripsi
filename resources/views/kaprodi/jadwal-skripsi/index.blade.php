...
<div class="row justify-content-center mt-3">
    <div class="col-md-12">
        <h1 class="mt-4 mb-4">Jadwal Sidang Skripsi {{$prodi}}</h1>
        <div class="d-flex justify-content-between">

            <div class="d-flex gap-2">
                <div class="">
                    <a href="{{  route('jadwal-skripsi.export', ['prodi' => $prodi]) }}" id="exportButton" class="btn btn-outline-secondary">Export</a>
                </div>
            </div>

            <div class="col-md-3 offset-md-3 text-md-end">
                <form action="{{ route('jadwal-skripsi.index') }}" method="GET">
                    <div class="input-group mb-3">
                        ...
                        @if ($search)
                        <a href="{{ route('jadwal-skripsi.index', ['prodi'=>$prodi]) }}" class="btn btn-outline-secondary">Clear</a>
                        @endif
                    </div>
                </form>
            </div>
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            <button class="btn btn-sm btn-primary open-modal"
                                ...
                                {{$d->jadwalSidang->status !== 'Pending' ? 'disabled' : ''}}>Edit Status
                            </button>
                        </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Approval Jadwal Sidang Skripsi</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('jadwal-skripsi.update-status') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 col-md-10 mx-auto">
                        ...
                        <textarea class="form-control" id="ket" name="keterangan" required></textarea>
                    </div>
                </div>
